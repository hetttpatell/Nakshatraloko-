    ...
    <>
      ...
      <div
        ...
        className={`fixed bottom-6 right-6 w-14 h-14 rounded-full bg-[var(--color-navy)] 
          ...
          cursor-pointer hover:opacity-90 transition z-50 ring-animation ${className}`}
      >
        <Phone size={24} />
      
      </div>
      <p className="font-playfair font-bold text-3xl sm:text-4xl md:text-5xl text-center text-[var(--color-navy)] mb-2">
            Book an Appointment
          </p>
